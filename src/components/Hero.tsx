...
const Hero = () => {
  ...
  return (
    ...
    >
      ...
      <div className="glow-orb w-[600px] h-[600px] top-0 left-0 opacity-30" />
      <div className="glow-orb w-[500px] h-[500px] bottom-0 right-0 opacity-40" />
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          {/* Right: Spline 3D */}
          <div ref={splineRef} className="relative h-[400px] md:h-[600px] lg:h-[700px]">
            <iframe
